...
app = Flask(__name__)
picam2 = Picamera2()
picam2.configure(picam2.create_preview_configuration(main={"size": (320, 240)}))  # Lower resolution for performance
picam2.start()
...
def generate_frames(zoom_factor=1.0):
    while True:
        ...
        # Clamp zoom_factor between 1 and 4
...
def index():
    return '''
    <h1>Raspberry Pi Camera Stream with Zoom</h1>
