...
sensor_power_pins = {
    ...
    8: 4     # Channel 8 sensor power GPIO (adjust if your wiring differs)
}
sensor_signal_pins = {
...
# ==== FACE ALIGNMENT / MEDIAPIPE SETUP ====
...
def generate_frames(zoom_factor=1.0):
    ...
    global led_state, current_channel, channel_index, channel_start_time
    ...
    while True:
        ...
        left_pupil = right_pupil = None  # Initialize pupil positions for drawing
        ...
        if len(faces) > 0:
            ...
            # Draw face bounding box and alignment box
            ...
            # Draw face alignment status text
            ...
            if face_aligned:
                ...
                if results.multi_face_landmarks:
                    ...
                    cv2.putText(zoomed, "No face landmarks detected", (10, 60),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 255), 2)

            # Draw eye movement status text
            ...
            # Draw pupil markers if available
